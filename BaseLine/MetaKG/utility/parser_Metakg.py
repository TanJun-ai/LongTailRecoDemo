...
def parse_args():
    ...
    """
    # parser.add_argument("--dataset", nargs="?", default="last-fm", help="Choose a dataset:[last-fm,movie-lens,Book-Crossing]")
    parser.add_argument("--dataset", nargs="?", default="movielens-1m")
    # parser.add_argument("--dataset", nargs="?", default="book_crossing")
    ...
    parser.add_argument("--dataset_path", default="../data/", help="Input data path.")
    # ===== train ===== #
    ...
    parser.add_argument('--use_pretrain', type=int, default=False, help='use pretrain data or not')
