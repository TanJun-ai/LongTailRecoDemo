...
n_user_dataset = {'movielens-1m': 3953, 'last-fm': 3846, 'book_crossing': 8000}
n_item_dataset = {'movielens-1m': 6041, 'last-fm': 1872, 'book_crossing': 2947}
...
def load_data(model_args, train_path, test_path):
    ...
    triplets = read_triplets(args.dataset_path + 'kg_final.txt')
    ...
    return train_cf, test_cf, user_dict, n_params, graph, [adj_mat_list, mean_mat_list]
